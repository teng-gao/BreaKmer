...
RUN_PARSER.add_argument('--rearr_min_seg_len', dest='rearr_minseg_len', default=20, type=int, help='Threshold for minimum segment to be rearranged. [default: %(default)s]')
RUN_PARSER.add_argument('--trl_min_seg_len', dest='trl_minseg_len', default=20, type=int, help='Threshold for minimum length of translocation segment. [default: %(default)s]')
...
SERVER_PARSER.add_argument('-k', '--keep_blat_server', dest='keep_blat_server', default=False, action='store_true', help='Keep the blat server alive. [default: %(default)s]')
